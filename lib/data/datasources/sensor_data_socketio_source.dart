...
class SensorDataSocketIOSource {
  ...
  IO.Socket? _socket;
  final StreamController<List<SensorDataModel>> _dataStreamController =
      StreamController<List<SensorDataModel>>.broadcast();
  ...
  SensorDataModel? get latestData =>
      _historicalData.isNotEmpty ? _historicalData.last : null;
